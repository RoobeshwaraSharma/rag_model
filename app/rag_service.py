...
def get_qa_chain():
    ...
    if _qa_chain is None:
        ...
        # Limit to 5 documents to avoid token limits (can be increased if needed)
        retriever = vectorstore.as_retriever(search_kwargs={"k": min(SEARCH_K, 5)})
...
- Suggest multiple relevant anime.
