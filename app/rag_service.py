...
def get_qa_chain():
    ...
    if _qa_chain is None:
        ...
        # Retrieve documents to get 10-12 recommendations (retrieve 15-20 for context)
...
Do not include any extra text outside the JSON."""
        ...
        def format_docs(docs):
            ...
            # Take first 15 documents and truncate each to max 200 chars
            formatted = []
            for doc in docs[:15]:  # Limit to 15 documents to have enough context for 10-12 recommendations
                content = doc.page_content[:200]  # Truncate each document to 200 chars
